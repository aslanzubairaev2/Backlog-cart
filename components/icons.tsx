...
export const GripVerticalIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75h.008v.008H9v-.008Zm0 3.75h.008v.008H9v-.008Zm0-7.5h.008v.008H9V9Zm3.75 0h.008v.008h-.008V9Zm0 3.75h.008v.008h-.008v-.008Zm0 3.75h.008v.008h-.008v-.008Zm3.75-7.5h.008v.008h-.008V9Zm0 3.75h.008v.008h-.008v-.008Zm0 3.75h.008v.008h-.008v-.008Z" />
    </svg>
);
